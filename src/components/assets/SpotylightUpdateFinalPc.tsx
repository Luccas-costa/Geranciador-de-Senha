...
interface SpotylightUpdateFinalPcProps {
  id: number;
  origem: string;
  email: string;
  senha: string;
...
export default function SpotylightUpdateFinalPc({
  origem,
  email,
  senha,
  IsLoading,
    ...
    <div className='absolute top-0 left-0 w-full h-full bg-black/50 flex items-center justify-center z-50'>
      <div>
        <form className='flex flex-col space-y-3 items-center justify-center'>
          ...
          <input
            type='text'
            className='bg-zinc-200/80 w-[700px] p-6 rounded-xl shadow-2xl text-neutral-900'
            value={Origem}
